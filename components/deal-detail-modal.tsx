...
// Компонент формы создания мопеда
function CreateMopedForm({
  onSave,
  onClose,
}: {
  onSave: (moped: Omit<Moped, "id" | "createdAt">) => void
  onClose: () => void
}) {
  const [formData, setFormData] = React.useState({
    brand: "",
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <h2 className="text-xl font-semibold">Создать новый мопед</h2>
      <div className="space-y-4">
        <div>
          <Label htmlFor="create-brand">Марка *</Label>
          <Input
            id="create-brand"
            value={formData.brand}
            onChange={(e) => setFormData({ ...formData, brand: e.target.value })}
        ...
        <div>
          <Label htmlFor="create-model">Модель *</Label>
          <Input
            id="create-model"
            value={formData.model}
            onChange={(e) => setFormData({ ...formData, model: e.target.value })}
        ...
        <div>
          <Label htmlFor="create-license">Гос. номер *</Label>
          <Input
            id="create-license"
            value={formData.licensePlate}
            onChange={(e) => setFormData({ ...formData, licensePlate: e.target.value })}
      ...
      <div className="flex justify-end gap-2 pt-4">
        ...
        <Button type="submit" disabled={!formData.brand || !formData.model || !formData.licensePlate}>
          Создать
        </Button>
      </div>
    </form>
...
// Компонент формы создания контакта
function CreateContactForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <h2 className="text-xl font-semibold">Создать новый контакт</h2>
      <div className="space-y-4">
        <div>
          <Label htmlFor="create-contact-name">Имя *</Label>
          <Input
        ...
        <div>
          <Label htmlFor="create-contact-phone">Телефон *</Label>
          <Input
        ...
        <div>
          <Label htmlFor="create-contact-iin">ИИН</Label>
          <Input
            id="create-contact-iin"
            value={formData.iin}
            onChange={(e) => setFormData({ ...formData, iin: e.target.value })}
            placeholder="123456789012"
          />
        ...
        <div>
          <Label htmlFor="create-contact-doc">Номер документа</Label>
          <Input
            id="create-contact-doc"
            value={formData.docNumber}
            onChange={(e) => setFormData({ ...formData, docNumber: e.target.value })}
